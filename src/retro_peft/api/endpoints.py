            ...
            try:
                ...
                for i, response in enumerate(responses):
                    ...
                    result = InferenceResponse(
                        ...
                        retrieval_info=response.get("retrieval_info") if request.return_retrieval_info else None,
                        metadata=response.get("metadata")
                    )
        ...
        async def get_metrics(
            ...
            try:
                ...
                scaling_metrics = {
                    ...
                    "load_balancer": self.gateway.load_balancer.get_stats() if self.gateway.load_balancer else None
                }
