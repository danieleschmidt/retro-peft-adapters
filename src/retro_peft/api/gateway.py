...
from ..scaling.load_balancer import LoadBalancer, Backend
...
class APIGateway:
    ...
    def _setup_routes(self):
        ...
        self.app.include_router(
            self.inference_api.router,
            prefix="/v1/inference",
            tags=["inference"]
        )
        
        self.app.include_router(
            self.health_api.router,
            prefix="/health",
            tags=["health"]
        )
    ...
    def get_rate_limit_dependency(self) -> Callable:
        ...
        async def rate_limit_dependency(
            request: Request,
            auth_result: AuthResult = Depends(self.get_auth_dependency())
        ) -> bool:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "metrics": self.metrics.get_performance_summary() if self.config.enable_metrics else None
        }
