...
class ContextualRetriever:
    ...
    def retrieve_with_context(
        ...
        **kwargs
        ...
        if personalization_vector is not None:
            query_embedding = self._apply_personalization(
                query_embedding, personalization_vector
            )
    ...
    def _apply_personalization(
        ...
        personalized_embedding = (
            (1 - personalization_weight) * query_embedding +
            personalization_weight * personalization_vector
        )
    ...
    def retrieve_multi_turn(
        ...
        **kwargs
        ...
        if turn_weights is None:
            ...
            turn_weights = [
                self.temporal_decay ** (len(conversation) - i - 1)
    ...
    def _get_recent_topics(self) -> List[str]:
        ...
        recent_queries = [
            turn["query"] for turn in self.conversation_history[-5:]
        ]
